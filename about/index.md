...
<div class="row">
  <div class="span8">
    ...
    decentralized and self-regulating, with a <a
    href="http://en.wikipedia.org/wiki/Demurrage_%28currency%29">demurrage
    fee</a> that ensures its circulation and bearers of the currency
    ...
    <a href="http://en.wikipedia.org/wiki/Proof-of-work_system">proof-of-work</a>
    block chain used by Satoshi Nakamoto in the 
    <a href="http://bitcoin.org/bitcoin.pdf">creation</a> of 
    <a href="http://bitcoin.org/">Bitcoin</a>. It includes a 
    <a href="https://github.com/freicoin/freicoin/downloads/">downloadable client</a> 
    ...
    software project <a href="https://github.com/freicoin/freicoin">on Github</a>.
    </p>
  </div>
  <div class="span4">
    ...
    <div class="caption" style="font-size:75%;line-height:120%;">
      ...
      <em>Occupy: Wall St.</em> and debt-free money.
      </p>
...
**[Demurrage
  currencies](http://en.wikipedia.org/wiki/Demurrage_%28currency%29)
...
**Freicoin provides a perpetual security subsidy**. A somewhat
  ...
  commons](http://en.wikipedia.org/wiki/Tragedy_of_the_commons) type
  of market failure when all bitcoins are issued and the block subsidy
  for miners ceases has [been
  considered](https://en.bitcoin.it/wiki/Tragedy_of_the_Commons) by
...
<dl>
  ...
  <dd>
  <a href="http://bitcoin.org/">Bitcoin</a> is a decentralized,
  ...
  <a href="http://www.weusecoins.com/">We Use Coins</a>.
  </dd>
</dl>
...
Examples of
[demurrage-money](http://en.wikipedia.org/wiki/Demurrage_%28currency%29)
...
Years](http://en.wikipedia.org/wiki/Debt:_The_First_5000_Years).

Demurrage-money was re-introduced to the modern era in the early
20<sup>th</sup> century by the theoretical economist, social activist,
and anarchist [Silvio
Gesell](http://en.wikipedia.org/wiki/Silvio_Gesell). Gesell discovered
...
profits](http://en.wikipedia.org/wiki/Economic_profit) tend to zero in
[perfect
competition](http://en.wikipedia.org/wiki/Perfect_competition). So
...
causing an [economic rent](http://en.wikipedia.org/wiki/Economic_rent)
...
solution](http://wikilivres.ca/wiki/The_Natural_Economic_Order)
...
times](http://en.wikipedia.org/wiki/Worgl_Experiment#The_W.C3.B6rgl_Experiment)
with [positive results](http://en.wikipedia.org/wiki/Chiemgauer).
...
Lietaer](http://en.wikipedia.org/wiki/Bernard_Lietaer), this short
term thinking is not inherent to humans but caused by some existing
monetary systems. He explains this with a [tree
metaphor](http://content.wuala.com/contents/jtimon/temp/what%20do%20we%20invest%20in.jpg).
...
**Demurrage currency can result in stable prices**. According to the
  [quantitive monetary
  theory](http://en.wikipedia.org/wiki/Equation_of_exchange), prices
...
economics](http://en.wikipedia.org/wiki/Austrian_School) underlies
...
E.C. Riegel was [a strong opponent of a state monopoly on
money](http://www.newapproachtofreedom.info/). Bernard Lietaer argues
that [both competition and diversity are important for the efficiency
and resilience of a market
economy](http://www.youtube.com/watch?v=ykvRceBQRl8). There are many
other inspirations to defend a free monetary market inclusive of both
Bitcoin and Freicoin.

**Bitcoin and Freicoin support each other as collaborative free
  software**. [Free
  software](http://www.gnu.org/philosophy/free-sw.html) is software
...
The [merged mining](http://dot-bit.org/Merged_Mining) technology first
...
**Finally: Freicoin, an electronic economy that is fair, and where the
  ...
  [download Freicoin today](/download/), give it a try, and find out
  for yourself.**
