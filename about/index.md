...
Some Austrian-school economists claim that the basic interest can be explained by what they call “time preference.” They maintain that people always prefer to have things in the present than having them in the future. That is, short-term thinking is part of human nature. (This would only be true for items like money, for example, as you wouldn’t necessarily prefer 1000 fresh apples today over 1 fresh apple a day for the next 1000 days, even if that holds true for U.S. dollars.)
