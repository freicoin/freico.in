...
**Anything that is not perishable becomes much more valuable**, as a consequence of having a perishable money supply. If you follow the news, you know the world is in an economic depression or recession. Even with this condition, the risk-free interest rate is 3%! Even during the Great Depression these rates only decreased to two percent. When the economy gets hot these rates reach as high as 15%. Thus, consumable products are perpetually overvalued, and sustainable products are always undervalued.

Some austrian economists claim that the basic interest can be explained by what they call “time preference.” They maintain that people always prefer to have things in the present than having them in the future. That is, short-term thinking is part of human nature. (This would only be true for items like money, for example, as you wouldn’t necessarily prefer 1000 fresh apples today over 1 fresh apple a day for the next 1000 days, even if that holds true for U.S. dollars.)
...
We don’t compete with bitcoin for miners either. **Merged mining allows network operators to secure both currencies simultaneously**. The [merged mining](http://dot-bit.org/Merged_Mining) technology first developed for Namecoin allows miners to use their proof of work in several block chain networks simultaneously.
